...
The action queue doesn't have to be in the same database the kit uses,
so one process can be responsible for queuing tasks and another for running them.
...
<b>Kit 1.0.0 has not been released yet. An official release is expected soon.</b>
...
download a {pre-build kit}[https://github.com/razor-x/kit/wiki/Pre-built-kits] or
